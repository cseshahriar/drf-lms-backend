...
urlpatterns = [
    ...
    path(
        "teacher/best-course-earning/<teacher_id>/",
    ...
    path(
        "teacher/course-create/", api_views.CourseCreateAPIView.as_view()),
    path(
    ...
    path(
        "teacher/course/variant-item-delete/<variant_id>/<variant_item_id>/<teacher_id>/<course_id>/",  # noqa
